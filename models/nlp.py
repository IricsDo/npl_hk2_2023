import models.action_parsing_dependcy_grammar as apdg
import re
import pandas as pd
import copy
...
class NLP:
    ...
    def parsing_dependency_grammar(self, sentence : list, index_sentence: int):
        ...
        df.to_excel(f'output/parsing_dependency_grammar/{index_sentence + 1}.xlsx')
    ...
    def grammatical_relations(self, relation : list, index_sentence: int):
        ...
        df.to_excel(f'output/grammatical_relations/{index_sentence+1}.xlsx')
    ...
    def logical_form(self, pre_logical_form: list, index_sentence : int):
        ...
        with open(f'output/logical_form/{index_sentence + 1}.txt', 'w', encoding='utf-8') as f:
    ...
    def procedural_semantics(self, logical_form : list, index_sentence: int):
        ...
        with open(f'output/procedural_semantics/{index_sentence + 1}.txt', 'w', encoding='utf-8') as f:
    ...
    def answer_question(self, final_resutl: str, index_sentence : int):
        ...
        with open(f'output/answer_question/{index_sentence + 1}.txt', 'w', encoding='utf-8') as f:
            f.write(answer)
